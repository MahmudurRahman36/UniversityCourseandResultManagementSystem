...
{
    public class UnassignCourseGateway:CommonGateway
    {
        public List<int> GetCourseIdList()
        {
            ...
            using (Connection)
            {
                ...
                string query = "select * from CourseAssaign;";
        ...
        public bool SetImvisible(int id)
        {
            ...
            {
                Connection.Open();
                string query = "UPDATE CourseAssaign set Visible =@Visible where ID = @ID;";
